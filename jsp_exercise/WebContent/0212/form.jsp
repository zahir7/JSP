...
<td><TEXTAREA name="add" rows="3" cols="50"> </TEXTAREA><BR>
</td>
</tr>

<tr>
<td align="center">생년월일</td>
<td><input type="radio" name="birth" value="양력">양력
<input type="radio" name="birth" value="음력">음력
<input type="text" name="birth1" size="10"> 예)1991/02/15
</td>
</tr>
...
<td><input type="radio" name="ox" value="예" checked>예
<input type="radio" name="ox" value="아니요">아니요</td>
</tr>
