	...
	public List getArticles(int start, int end, String writer) throws Exception {
		...
		try {
			...
			pstmt = conn.prepareStatement(
					...
					"from board order by ref desc, re_step asc) order by ref desc, re_step asc ) where r >= ? and r <= ? and writer like ?");
...
public int pwArticle(int num, String passwd) throws Exception {
	Connection conn = null;
	PreparedStatement pstmt = null;
	ResultSet rs= null;
	String dbpasswd="";
